...
var cercaStudentiVotoMaggioreDi = function cercaStudentiVotoMaggioreDi(voto){
	studentiSelezionati = [];
	for (i=0; i < studentList.length; i++){
		if(studentList[i].mark>voto){
			studentiSelezionati.push(studentList[i]);
		}
	}
...
var cercaStudentiVotoMinoreDi = function cercaStudentiVotoMinoreDi(voto){
	studentiSelezionati = [];
	for (i=0; i < studentList.length; i++){
		if(studentList[i].mark<voto){
			studentiSelezionati.push(studentList[i]);
